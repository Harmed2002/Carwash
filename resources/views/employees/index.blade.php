...
@section('content')
    <div class="card card-info">
        <div class="card-header">
            <h1 class="card-title"><i class="fas fa-user-tag"></i>  Listado de Empleados</h1>
        </div>
                                ...
                                <tbody id="tbody_employee" name="tbody_employee">
                                    @foreach ($employees as $empl)
                                        <tr id="tr_{{ $empl->id }}"
                                            ...
                                            <td>{{ $empl->Person->pers_direccion }}<br>{{ $empl->Person->City->ciud_nombre }} - {{ $empl->Person->State->dpto_nombre }}</td>
