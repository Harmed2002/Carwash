...
<!-- , ['iFrameEnabled' => true] -->
@section('title', 'Listado de Tipo de Servicios')
...
@section('content')
    <div class="card card-info">
        <div class="card-header">
            <h1 class="card-title"><i class="fab fa-whmcs"></i>  Listado de Tipo de Servicios</h1>
        </div>
            ...
            <div  class="dataTables_wrapper dt-bootstrap4">
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-6 mb-2">
                        <button class="btn btn-primary" onclick="createServiceType()" type="button">Crear</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-12 col-md-12">
                        <div class="table-responsive">
                            <table id="serviceTypeTable" class="table table-bordered table-striped dataTable dtr-inline">
                                ...
                                <tbody id="tbody_serviceType" name="tbody_serviceType">
...
@section('js')
    ...
    <script src="{{ asset('js/serviceType/functions.js') }}"></script>
